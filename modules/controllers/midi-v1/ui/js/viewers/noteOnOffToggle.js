 ...
 */
function ensureNoteOnOffToggleShape (a, context) {
...
function mountNoteOnOffToggleEditor (container, api) {
  ...
  ensureNoteOnOffToggleShape(a, ctx)
  const p = /** @type {Record<string, unknown>} */ (a.params)
  ...
  if (resolveEditorTargetKind(a, ctx) !== 'action') {
    envUi = mountEnvArRow(frag, {
      getParams: () => {
        ...
        ensureNoteOnOffToggleShape(asg, ctx)
  ...
  function syncFromModel () {
    ensureNoteOnOffToggleShape(api.getAssignment(), ctx)
