class Derby3c extends LightBase {
  ...
  applyIntentSnapshot (_context, snapshot) {
    ...
    // Single-line icon rotates toward hub lookAt (approximate — derby angle is uncalibrated).
  ...
  draw (ctx, cx, cy, ppm) {
    ...
    const outline = globalThis.SimFixtureIcons?.derby3c
